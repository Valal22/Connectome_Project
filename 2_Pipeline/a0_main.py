...
def run_rand_pipeline(excel_path, num_epochs, p, seed):
    # 1. Load dataset
    A_target, neurons = load_hermaphrodite_chemical_connectome(excel_path)
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default=r"C:\Users\39340\Downloads\SI_5_Connectome_adjacency_matrices_corrected_July_2020.xlsx",
